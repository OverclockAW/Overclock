...
define('BD_NAME', 'overclock');
define('BD_USER', 'overclock');
define('BD_PASS', 'overclock');
define('RAIZ_APP', __DIR__);
define('RUTA_APP', '/Overclock/');
define('RUTA_INCLUDE', RUTA_APP.'includes/');
define('RUTA_IMGS', RUTA_APP.'img/');
define('RUTA_CSS', RUTA_APP.'css/');
define('RUTA_SCRIPTS', RUTA_APP.'scripts/');
...
/* */
$app = \xampp\htdocs\Overclock\Aplicacion::getSingleton();
